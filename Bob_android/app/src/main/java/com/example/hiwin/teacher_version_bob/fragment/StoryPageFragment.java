...
public class StoryPageFragment extends StaticFragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        (root.findViewById(R.id.story_page_previous)).setOnClickListener(onClickListener);
        (root.findViewById(R.id.story_page_speak)).setOnClickListener(onClickListener);
        (root.findViewById(R.id.story_page_next)).setOnClickListener(onClickListener);

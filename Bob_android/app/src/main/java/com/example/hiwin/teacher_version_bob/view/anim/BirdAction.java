...
public class BirdAction implements AnimateAction, Animator.AnimatorListener {
    private Animator.AnimatorListener listener;
    private Context context;
    public BirdAction(Context context, Animator.AnimatorListener listener) {
    ...
    public AnimatorSet getAnimatorSet(Face face, int repeatCount) {
        face.getIface().setImageDrawable(context.getDrawable(R.drawable.face_smiling));
